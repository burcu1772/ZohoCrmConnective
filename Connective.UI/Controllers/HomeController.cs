...
using Connective.UI.Models.UIModels;

namespace Connective.UI.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult RecordList()
        {
            ...
            List<SelectListItem> SortingFilter = new List<SelectListItem> {
                new SelectListItem { Text = "Sıralama Ölçüsü Seçiniz", Value = "-1", Selected = true },
                new SelectListItem { Text = "Artan", Value = "0", Selected = false },
                new SelectListItem { Text = "Azalan", Value = "", Selected = false }
            };
        ...
        {
            List<Record> recordList = new List<Record> { obj };
        ...
        public IActionResult UpdateRecord(string id)
        {
            ...
            Record newrecord = new Record { Id = Convert.ToInt64(id) };
